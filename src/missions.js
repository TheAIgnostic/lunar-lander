...
export const IO_MISSIONS = [
  {
    ...
    terrain: { archetype: 'caldera' },
    pads: [{ mult: 3, width: 120 }, { mult: 2, width: 212 }],
    hazards: [{ type: 'heat', heatRise: 9, heatFall: 0.8 }],
  ...
  },
  {
    ...
    pads: [{ mult: 4, width: 102 }, { mult: 3, width: 185 }],
    hazards: [
      { type: 'heat', heatRise: 10, heatFall: 0.8 },
  ...
  },
  {
    ...
    pads: [{ mult: 4, width: 82 }, { mult: 3, width: 157 }],
    hazards: [
      { type: 'heat', heatRise: 11.5, heatFall: 0.8 },
  ...
  },
  {
    ...
    pads: [{ mult: 6, width: 72 }, { mult: 2, width: 160 }],
    hazards: [
      { type: 'heat', heatRise: 13, heatFall: 0.8 },
  ...
  },
  {
    ...
    pads: [{ mult: 6, width: 64 }, { mult: 2, width: 132 }],
    hazards: [
      { type: 'heat', heatRise: 14, heatFall: 0.8 },
...
export const MERCURY_MISSIONS = [
  {
    ...
    terrain: { archetype: 'crater' },
    pads: [{ mult: 3, width: 120 }, { mult: 2, width: 212 }],
    hazards: [{ type: 'heat', heatRise: 9, heatFall: 1.45 }],
    optionalObjective: { id: 'low-heat', text: 'Land with engine heat under 45%', reward: { salvage: 45 } },
    enemyBudget: 0,
  },
  {
    ...
    terrain: { archetype: 'ridge' },
    pads: [{ mult: 4, width: 102 }, { mult: 3, width: 185 }],
    hazards: [{ type: 'heat', heatRise: 10.5, heatFall: 1.45 }],
  ...
  },
  {
    ...
    terrain: { archetype: 'crater' },
    pads: [{ mult: 4, width: 82 }, { mult: 3, width: 157 }],
    hazards: [{ type: 'heat', heatRise: 11, heatFall: 2.6 }],
  ...
  },
  {
    ...
    terrain: { archetype: 'caldera' },
    pads: [{ mult: 6, width: 72 }, { mult: 2, width: 160 }],
    hazards: [{ type: 'heat', heatRise: 12.5, heatFall: 1.45 }],
  ...
  },
  {
    ...
    terrain: { archetype: 'ridge' },
    pads: [{ mult: 6, width: 64 }, { mult: 2, width: 132 }],
    hazards: [{ type: 'heat', heatRise: 14, heatFall: 1.45 }],
