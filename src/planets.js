...
export const PLANETS = {
  ...
  MARS: P({
    ...
    feelOffset: 1.0, atmosphere: 'thin', drag: 0.15, wind: 24, gust: 20, visibility: 0.85,
    hazards: ['wind', 'dust'],
  ...
  VENUS: P({
    ...
    hazards: ['drag', 'acid', 'downdraft', { type: 'dust', period: 12, minVisibility: 0.5, duty: 0.6 }],
  ...
  TITAN: P({
    ...
    hazards: ['wind', 'glide', { type: 'dust', period: 17, minVisibility: 0.62, duty: 0.5 }],
  ...
  ENCELADUS: P({
    ...
    feelOffset: 1.15, surfaceFriction: 0.3, terrainStyle: 'ice', hazards: ['plume'],
  ...
  PLUTO: P({
    ...
    feelOffset: 1.08, visibility: 0.45, surfaceFriction: 0.25, hazards: ['cold', 'darkness'],
    terrainStyle: 'ice',
  ...
  GANYMEDE: P({
    ...
    feelOffset: 1.0, surfaceFriction: 0.5, hazards: ['magnetic', 'falseRadar'],
    terrainStyle: 'ice',
